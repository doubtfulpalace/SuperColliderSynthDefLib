...
NODEFUNC(Add, "BinaryOpUGen", 2, false, 2, {"a" COMMA "b"}, {0 COMMA 0}, 1, {2}, 0);
NODEFUNC(Sub, "BinaryOpUGen", 2, false, 2, {"a" COMMA "b"}, {0 COMMA 0}, 1, {2}, 1);
...
NODEFUNC(BitwiseAnd, "BinaryOpUGen", 2, false, 2, {"a" COMMA "b"}, {0 COMMA 0}, 1, {2}, 14);
NODEFUNC(BitwiseOr, "BinaryOpUGen", 2, false, 2, {"a" COMMA "b"}, {0 COMMA 0}, 1, {2}, 15);
NODEFUNC(BitshiftLeft, "BinaryOpUGen", 2, false, 2, {"a" COMMA "b"}, {0 COMMA 0}, 1, {2}, 26);
NODEFUNC(BitshiftRight, "BinaryOpUGen", 2, false, 2, {"a" COMMA "b"}, {0 COMMA 0}, 1, {2}, 27);
NODEFUNC(UnsignedBitshiftRight, "BinaryOpUGen", 2, false, 2, {"a" COMMA "b"}, {0 COMMA 0}, 1, {2}, 28);
// Lua maps > and >= to < and <= with swapped arguments, so we only define the latter
NODEFUNC(LessThan, "BinaryOpUGen", 2, false, 2, {"a" COMMA "b"}, {0 COMMA 0}, 1, {2}, 8);
NODEFUNC(LessThanOrEqualTo, "BinaryOpUGen", 2, false, 2, {"a" COMMA "b"}, {0 COMMA 0}, 1, {2}, 10);
